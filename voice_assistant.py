...
# TODO: add support for multiples of 100.
quantity_no_mapping_dic = {"एक":1,"दो":2,"तीन":3,"चार":4,"पांच":5,"छह":6,"सात":7,"आठ":8,"नौ":9,"दस":10,"बीस":20,"तीस":30,"चालीस":40,"पचास":50,"साठ":60,"सत्तर":70,"अस्सी":80,"नब्बे":90,"सौ":100, "ढाई":0.25, "आधा":0.5}
entity_name  = []
quantity = []
price = []
cost = []
...
def pretty_invoice_print(entity_name, quantity, price, np_cost, final_total):
    ...
    total = "TOTAL: (" + str(counter) + " items)"
    invoice_sum = "SUM: Rs. " + str(final_total)

    invoice_rows.append([total,'','','', invoice_sum])
...
def main():
    ...
    commands = ["लिप्टन दो पैकेट","सूजी सौ ग्राम","हार्पिक एक पीस","गार्नियर एक पीस","आटा चार किलो","मैगी तीन पैकेट","एक्लेयर्स नौ पीस","सेंसिटिव एक पीस"]
